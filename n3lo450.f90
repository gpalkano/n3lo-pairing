...
!c
      common /cchi/ vj(32,270),c(20,270),fff,ff,f(52),aa(96),ai(19,30),&
                     ...
                     gaa(3),fpia(3),ezz1(3),ezz2(3),ct(96),wt(96),&
...
!c
      ...
      expo=(xmev/cutlsj(2,15))**(2.d0*cutlsj(1,15)) &
         +(ymev/cutlsj(2,15))**(2.d0*cutlsj(1,15))
...
!c
      ...
      expo=(xmev/cutlsj(2,1))**(2.d0*cutlsj(1,1)) &
         +(ymev/cutlsj(2,1))**(2.d0*cutlsj(1,1))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv0(1)=vv0(1)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(4,1))**(2.d0*cutlsj(3,1)) &
         +(ymev/cutlsj(4,1))**(2.d0*cutlsj(3,1))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv2(1)=vv2(1)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(6,1))**(2.d0*cutlsj(5,1)) &
         +(ymev/cutlsj(6,1))**(2.d0*cutlsj(5,1))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv4(1)=vv4(1)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(2,2))**(2.d0*cutlsj(1,2)) &
         +(ymev/cutlsj(2,2))**(2.d0*cutlsj(1,2))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv2(3)=vv2(3)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(4,2))**(2.d0*cutlsj(3,2)) &
         +(ymev/cutlsj(4,2))**(2.d0*cutlsj(3,2))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv4(3)=vv4(3)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(2,3))**(2.d0*cutlsj(1,3)) &
         +(ymev/cutlsj(2,3))**(2.d0*cutlsj(1,3))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv2(1)=vv2(1)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(4,3))**(2.d0*cutlsj(3,3)) &
         +(ymev/cutlsj(4,3))**(2.d0*cutlsj(3,3))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv4(1)=vv4(1)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(2,4))**(2.d0*cutlsj(1,4)) &
         +(ymev/cutlsj(2,4))**(2.d0*cutlsj(1,4))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv2(2)=vv2(2)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(4,4))**(2.d0*cutlsj(3,4)) &
         +(ymev/cutlsj(4,4))**(2.d0*cutlsj(3,4))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv4(2)=vv4(2)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(2,5))**(2.d0*cutlsj(1,5)) &
         +(ymev/cutlsj(2,5))**(2.d0*cutlsj(1,5))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv0(4)=vv0(4)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(4,5))**(2.d0*cutlsj(3,5)) &
         +(ymev/cutlsj(4,5))**(2.d0*cutlsj(3,5))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv2(4)=vv2(4)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(6,5))**(2.d0*cutlsj(5,5)) &
         +(ymev/cutlsj(6,5))**(2.d0*cutlsj(5,5))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv4(4)=vv4(4)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(2,6))**(2.d0*cutlsj(1,6)) &
         +(ymev/cutlsj(2,6))**(2.d0*cutlsj(1,6))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv4(3)=vv4(3)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(2,7))**(2.d0*cutlsj(1,7)) &
         +(ymev/cutlsj(2,7))**(2.d0*cutlsj(1,7))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv2(5)=vv2(5)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(4,7))**(2.d0*cutlsj(3,7)) &
         +(ymev/cutlsj(4,7))**(2.d0*cutlsj(3,7))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv4(5)=vv4(5)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(2,8))**(2.d0*cutlsj(1,8)) &
         +(ymev/cutlsj(2,8))**(2.d0*cutlsj(1,8))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv4(1)=vv4(1)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(2,9))**(2.d0*cutlsj(1,9)) &
         +(ymev/cutlsj(2,9))**(2.d0*cutlsj(1,9))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv4(2)=vv4(2)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(2,10))**(2.d0*cutlsj(1,10)) &
         +(ymev/cutlsj(2,10))**(2.d0*cutlsj(1,10))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv2(4)=vv2(4)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(4,10))**(2.d0*cutlsj(3,10))&
         +(ymev/cutlsj(4,10))**(2.d0*cutlsj(3,10))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv4(4)=vv4(4)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(2,12))**(2.d0*cutlsj(1,12)) &
         +(ymev/cutlsj(2,12))**(2.d0*cutlsj(1,12))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
      vv4(5)=vv4(5)*expexp
...
!c
      ...
      expo=(xmev/cutlsj(2,11))**(2.d0*cutlsj(1,11)) &
         +(ymev/cutlsj(2,11))**(2.d0*cutlsj(1,11))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
!c
...
!c
      ...
      expo=(xmev/cutlsj(2,13))**(2.d0*cutlsj(1,13)) &
         +(ymev/cutlsj(2,13))**(2.d0*cutlsj(1,13))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
!c
...
!c
      ...
      expo=(xmev/cutlsj(2,14))**(2.d0*cutlsj(1,14)) &
         +(ymev/cutlsj(2,14))**(2.d0*cutlsj(1,14))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
!c
...
!c
      ...
      expo=(xmev/cutlsj(2,16))**(2.d0*cutlsj(1,16)) &
         +(ymev/cutlsj(2,16))**(2.d0*cutlsj(1,16))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
!c
...
!c
      ...
      expo=(xmev/cutlsj(2,17))**(2.d0*cutlsj(1,17)) &
         +(ymev/cutlsj(2,17))**(2.d0*cutlsj(1,17))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
!c
...
!c
      ...
      expo=(xmev/cutlsj(2,18))**(2.d0*cutlsj(1,18)) &
         +(ymev/cutlsj(2,18))**(2.d0*cutlsj(1,18))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
!c
...
!c
      ...
      expo=(xmev/cutlsj(2,19))**(2.d0*cutlsj(1,19)) &
         +(ymev/cutlsj(2,19))**(2.d0*cutlsj(1,19))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
!c
...
!c
      ...
      expo=(xmev/cutlsj(2,20))**(2.d0*cutlsj(1,20)) &
         +(ymev/cutlsj(2,20))**(2.d0*cutlsj(1,20))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
!c
...
!c
      ...
      expo=(xmev/cutlsj(2,22))**(2.d0*cutlsj(1,22)) &
         +(ymev/cutlsj(2,22))**(2.d0*cutlsj(1,22))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
!c
...
!c
      ...
      expo=(xmev/cutlsj(2,25))**(2.d0*cutlsj(1,25)) &
         +(ymev/cutlsj(2,25))**(2.d0*cutlsj(1,25))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
!c
...
!c
      ...
      expo=(xmev/cutlsj(2,27))**(2.d0*cutlsj(1,27)) &
         +(ymev/cutlsj(2,27))**(2.d0*cutlsj(1,27))
      if (expo.gt.rrr) expo=rrr
      expexp=dexp(-expo)
      end if
!c
...
!c
      common /compar/ cb1a(3),cb2a(3),cb3a(3),cb4a(3),&
                     ...
                     ce14a(3),ce15a(3),ce16a(3),ce17a(3)
!c
      common /comlsj/ clsj(15,50),cutlsj(15,50),indlsj
      logical indlsj
!c
...
!c
      data ((tab(i,j),i=1,5),j=1,99)/ &
         6.000000000d0,   0.0d0,    4.0000d0,  450.0d0,   0.0d0,&
        -1.290000000d0,  92.4d0,  134.9766d0,    0.0d0,   0.0d0,&
         0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
        -1.290000000d0,  92.4d0,  139.5702d0,    0.0d0,   0.0d0,&
        -0.062170000d0,  92.4d0,  139.5702d0,    0.0d0,   0.0d0,&
        10.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         0.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         6.000000000d0,   0.0d0,    2.0000d0,  450.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,&
        13.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,&
        14.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
        -1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,&
        11.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
        14.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,&
        57.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,&
        59.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
        -1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,&
        11.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
        59.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,&
        81.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,&
        82.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,&
        83.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
        -1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,&
        11.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
        83.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,&
        84.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
        -1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,&
        11.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
        84.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,&
        19.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,&
        20.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,&
        30.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,&
        ...
        31.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,&
        40.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
        -1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,&
        41.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,&
        41.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
        11.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
        -1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,&
        42.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,&
        42.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
        11.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,&
        43.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
        -1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,&
        44.000000000d0,  24.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,&
        44.000000000d0,  24.0d0,    0.0000d0,    0.0d0,   0.0d0,&
        11.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,&
        45.000000000d0,  24.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         4.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,&
        36.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,&
        36.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
        11.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,&
        ...
        11.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,&
        38.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         1.000000000d0,   0.0d0,  138.0390d0,    0.0d0,  -1.0d0,&
        39.000000000d0,   0.0d0,    0.0000d0,    0.0d0,   0.0d0,&
         0.000000000d0,   0.0d0,    2.0000d0,  450.0d0,   0.0d0,&
        -0.148260070d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,&
         2.433681676d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,&
        -1.994401772d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,&
       -17.030231473d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,&
         1.154243531d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,&
         5.058102140d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,&
         0.014160390d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,&
        11.337758526d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,&
        -0.846304327d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,&
         4.903722331d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,&
        -0.1487638807d0,  3.0d0,  450.0000d0,    0.0d0,   0.0d0,&
         0.706331009d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,&
        -6.695551216d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0/
!c
      data ((tab(i,j),i=1,5),j=100,122)/ &
       -14.382027321d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,&
        -5.698103525d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,&
         0.478194099d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,&
         0.314046356d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,&
         2.605874012d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,&
        -2.001966897d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,&
        -3.525233090d0,   3.0d0,  450.0000d0,    0.0d0,   0.0d0,&
        -0.752384088d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,&
         5.794838454d0,   2.0d0,  450.0000d0,    0.0d0,   0.0d0,&
         0.019145921d0,   4.0d0,  450.0000d0,    0.0d0,   0.0d0,&
...
!c
      data topepp/ &
        -1.290000d0,  92.4d0,  134.9766d0,    0.0d0,   0.0d0,&
         0.000000d0,   0.0d0,  139.5702d0,    0.0d0,   0.0d0/
!c
!c
      data topenp/ &
        -1.290000d0,  92.4d0,  139.5702d0,    0.0d0,   0.0d0,&
        -0.062170d0,  92.4d0,  139.5702d0,    0.0d0,   0.0d0/
!c
!c
      data topenn/ &
        -1.290000d0,  92.4d0,  134.9766d0,    0.0d0,   0.0d0,&
...
!c
      data t1s0pp/ &
        -0.14660321102d0,  3.0d0,  450.0000d0,    0.0d0,   0.0d0/
!c
!c
      data t1s0np/ &
        -0.14826007d0,  3.0d0,  450.0000d0,    0.0d0,   0.0d0/
!c
!c
      data t1s0nn/ &
        -0.147518666d0,  3.0d0,  450.0000d0,    0.0d0,   0.0d0/
!c
!c
...
10002 format (1h /' contribution  par_1     par_2     mass     iso-spin&
         iprop'/9x,'fun-type  f u n c t i o n   p a r a m e t e r s')
...
10011 format (//' n3lo450new: Charge-Dependent Chiral NN Potential',&
     /' at Order Four using Lambda = 450 MeV, N3LO(450) of A.D.2017')
...
!c        store coupling constant f**2
      ...
      if (mg.eq.10) c(1,ime)=c(1,ime)+c(3,ime)*2.d0+c(2,ime)
      end if
!c
!c
...
19001 format (1h ////' error in chipar:too many contributions &
     within a g &
     roup with respect to'/' the given dimensions. &
...
19003 format (1h ////' error in chipar: factor typ has the non-permissi&
      ble value',i4,' .'/' execution terminated.'////)
      go to 9999
!c
!c
 9004 write (kwrite,19004) cc(4)
19004 format (1h ////' error in chipar: isospin has the non-permissib&
     le value',f10.4,'  .'/' execution terminated.'////)
      go to 9999
!c
!c
 9005 write (kwrite,19005) cc(5)
19005 format (1h ////' error in chipar: iprop/spe has the non-permissib&
     le value',f10.4,'  .'/' execution terminated.'////)
      go to 9999
!c
!c
...
19009 format (1h ////' error in chipar: the exponent of the cut-off is&
     less than zero.'/' execution terminated.'////)
      go to 9999
!c
!c
 9010 write (kwrite,19010)
19010 format (1h ////' error in chipar: too many cut/fun parameters &
     with respect to the given'/' dimensions. execution terminated.'////)
      go to 9999
!c
!c
 9011 write (kwrite,19011)
19011 format (1h ////' error in chipar:  too many contr. with respect &
     to the dimensions given'/' to this program. execution &
     terminated.'////)
      go to 9999
!c
!c
...
!c
      aajj=0.d0
      if (j.gt.1) aajj=aj/dsqrt(ajj1*ajj2)
!c
      aaj1=aajj*ajm1
      aaj2=aajj*aj1
      aaj3=aajj*2.d0
...
!c
 1300 if (.not.indla.or.cc4.ne.c4) go to 20
      ...
      brak=4.d0*c4*(5.d0*ga4-4.d0*ga2 -1.d0)&
         +akk*(23.d0*ga4-10.d0*ga2-1.d0)&
         +48.d0*ga4*c4*c4/radi
...
!c
 3900 if (.not.indla.or.cc4.ne.c4) go to 20
      ...
      brak=(cb2-6.d0*cb3)*akk*akk &
          +4.d0*(6.d0*cb1+cb2-3.d0*cb3)*akk*c4 &
          +6.d0*(cb2-2.d0*cb3)*c4*c4 &
          +24.d0*(2.d0*cb1+cb3)*c4*c4*c4/radi
...
!c     precalculate ImV(mu)
      if (.not.iv40) then
            ...
            do 4035 ii = 1, nmu
                  ...
                  v40(ii) = -ANS1/amu(ii)*&
              (  (c4 - 2.d0*amu2(ii))*(2.d0*wpi + ANS1/2.d0/amu(ii)*&
                 dlog((amu(ii) + 2.d0*wpi)/(amu(ii) - 2.d0*wpi)))&
                 + 4.d0*ga2*wpi*ANS1    )
 4035       continue
      end if
!c
...
!c     precalculate ImV(mu)
      if (.not.iv43) then
            ...
            do 4335 ii = 1, nmu
                  rootk = dsqrt(amu2(ii)/4.d0 - c4)
                  v43(ii) = rootk/amu(ii)*&
       (      (  (4.d0*c4*(1.d0 + 2.d0*ga2) &
                       - amu2(ii)*(1.d0 + 5.d0*ga2)) * rootk/amu(ii)*&
                 dlog((amu(ii) + 2.d0*rootk)/2.d0/wpi)&
                 + amu2(ii)*(5.d0 + 13.d0*ga2)/12.d0&
                 - 2.d0*c4*(1.d0 + 2.d0*ga2)&
                 + 96.d0*pi2*fpi2 * ( &
                       (2.d0*c4 - amu2(ii))*cd12 &
                       + 4.d0*c4*cd5)  )&
          *(ga2*(2.d0*c4-amu2(ii))+2.d0/3.d0*(ga2-1.d0)*rootk*rootk)&
       -192.d0*pi2*fpi2*cd3*rootk*rootk*(ga2/3.d0*(2.d0*c4-amu2(ii))&
                         +2.d0/5.d0*(ga2-1.d0)*rootk*rootk)        )
!c
 4335       continue
      end if
!c
...
!c
                        ...
                        brak5=ga2*ga2* &
                             (akk-2.d0*c4*wbarq*xixi+2.d0*c4)
!c
!c
                        term6=5.d0/6.d0-term24
                        step45=wxi(iii)*(brak1-brak2*xixi)&
                             *(brak3*xixi+term5-brak5*term6)
!c
...
!c
                 ...
                 (24.d0*cb1 + cb2*(u2 - 4.d0) + 6.d0*cb3*(u2 - 2.d0))&
                 *dlog((u + 2.d0)/(u - 2.d0))&
                 + 8.d0/u* &
              (  3.d0*(4.d0*cb1 + cb3*(u2 - 2.d0))* &
                 (1.d0 - 10.d0*ga4 + 4.d0*ga4*u2) &
                 + cb2*(6.d0*ga4*u2 - 10.d0*ga4 - 3.d0)  )*alogfn
!c
                  ANS2 = 3.d0*(2.d0 - u2)*(4.d0*cb1 + cb3*(u2 - 2.d0)) &
                 + cb2*(7.d0*u2 - 6.d0 - u4) &
                 + 4.d0*ga2/u*(2.d0*u2 - 1.d0)* &
                 (4.d0*(6.d0*cb1 - cb2 - 3.d0*cb3) &
                       + (cb2 + 6.d0*cb3)*u2)
!c                  
                  ANS3 = ga4*&
              (  128.d0/(2.d0+u)*(2.d0*cb1 + cb3) + 256.d0/u* &
                 (2.d0*cb1 + cb2/3.d0 - cb3) &
                      + 4.d0*(14.d0*cb3 - 5.d0*cb2 - 92.d0*cb1) &
                 + 32.d0*u*(6.d0*cb3 - 5.d0*cb2/3.d0) &
                 + 2.d0*u2/3.d0*(36.d0*cb1 + 13.d0*cb2 - 156.d0*cb3) &
                 + 2.d0*u4/3.d0*(2.d0*cb2 + 9.d0*cb3)               )
!c
...
!c
                 ...
                 - 1.d0/3.d0*u2m4*u2m4*uroot* &
                            dlog((u + 2.d0)/(u - 2.d0)) &
                 + u/3.d0*uroot*(ga2*(u3 - 30.d0*u + 64.d0) &
                       + 4.d0*u2 - 16.d0)
 4735       continue
      end if
!c
...
!c
 4900 if (.not.indla.or.cc4.ne.c4) go to 20
      ...
      brak1=(radi*(akk-4.d0*yyoff) &
           +8.d0*ga2*(11.d0/4.d0*akkq+5.d0*c4*akk+3.d0*c44 &
            -6.d0*c46/radi-yyoff*(8.d0*c4+5.d0*akk)) &
           +4.d0*ga4*(yyoff*(20.d0*c4+7.d0*akk-16.d0*c44/radi) &
            +16.d0*c48/radiq+12.d0*c46/radi-27.d0/4.d0*akkq &
            -11.d0*c4*akk-6.d0*c44))*ell(i)
...
!c
 5100 if (.not.indla.or.cc4.ne.c4) go to 20
      ...
      brak=radi-32.d0*ga2*(c4+7.d0/16.d0*akk) &
          +4.d0*ga4*(7.d0*c4+17.d0/4.d0*akk+4.d0*c44/radi)
...
!c
 5200 if (.not.indla.or.cc4.ne.c4) go to 20
      ...
      brak=-radi+16.d0*ga2*(c4+3.d0/8.d0*akk) &
          +4.d0/3.d0*ga4*(-9.d0*c4-11.d0/4.d0*akk+4.d0*c44/radi)
...
!c           ANS = {curly bracket}
           ...
           - (4.d0*c4 + 2.d0*akk - ga2*(7.d0*c4 + 4.5d0*akk))*cpaa(i)
!c
            aa(i)=aa(i)*c5*ANS
26205 continue
      mi=mi+1
...
!c           integrate over mu in [3m_pi, +infinity], and store result in aintmu
            ...
            do 26715 ii = 1, n3mu
                  aintmu = aintmu + w3mu(ii)*v67(ii) / &
                       (a3mu4(ii)*a3mu(ii)*(a3mu2(ii)+aakk))
26715       continue
!c
            aa(i)=aa(i)*c5*aintmu
26705 continue
...
!c
                 ...
                 (37.d0*u6 + 74.d0*u5 - 251.d0*u4 - 268.d0*u3 &
                       + 349.d0*u2 - 58.d0*u - 135.d0) &
                 + 2.d0*uln*(39.d0*u4 - 2.d0 - 52.d0*u2 - 6.d0*u6)
!c
                  v68(ii) = ANS/u3
26835       continue
      end if
...
!c
                ...
                ANS = uroot*((u-1d0)/12d0) &
                *(5.d0*u6 + 10.d0*u5 - 3.d0*u4 - 252.d0*u3 - 443.d0*u2 &
                       - 58.d0*u - 135.d0) &
                   + 4.d0*uln*(3.d0*u4 + 22.d0*u2 - 2.d0) 
!c
                  v69(ii) = ANS / u5
26935       continue
      end if
...
!c           integrate over mu in [3m_pi, +infinity], and store result in aintmu
            ...
            do 26915 ii = 1, n3mu
                  aintmu = aintmu + w3mu(ii)*v69(ii) / &
                       (a3mu2(ii)*a3mu(ii)*(a3mu2(ii)+aakk))
26915       continue
!c
            aa(i)=aa(i)*c5*aintmu
26905 continue
...
!c
                  ANS1 = uroot*(u - 1.d0)* &
              (  2.d0*cb1*u*(5.d0*u3 + 10.d0*u2 - 5.d0*u - 4.d0) &
                 + cb2/48.d0*(135.d0 + 58.d0*u - 277.d0*u2 - 36.d0*u3 &
                       + 147.d0*u4 - 10.d0*u5 - 5.d0*u6) &
                 + cb3/8.d0*(7.d0*u6 + 14.d0*u5 -145.d0*u4 - 20.d0*u3 &
                       + 111.d0*u2 + 18.d0*u + 27.d0) &
                 + cb4/6.d0*(44.d0*u3 + 37.d0*u4 - 14.d0*u5 - 7.d0*u6 &
                       - 3.d0*u2 - 18.d0*u - 27.d0)                  )
!c     
                  ANS2 = uln*(24.d0*cb1*(1.d0 + 4.d0*u2 - 3.d0*u4) &
                 + cb2*(2.d0 + 2.d0*u2 - 3.d0*u4) &
                 + 6.d0*cb3*u2*(3.d0*u2 - 2.d0) &
                 + 8.d0*cb4*u2*(u4 - 5.d0*u2 + 5.d0) )
!c
                  v70(ii) = (ANS1 + ANS2)/u3
27035       continue
      end if
...
!c
      ...
      term2=cb2/24.d0*(135.d0+58.d0*u+227.d0*u2+204.d0*u3 &
           +27.d0*u4-10.d0*u5-5.d0*u6)
      term3=cb3/4.d0*(27.d0+18.d0*u-9.d0*u2-68.d0*u3 &
           -121.d0*u4+14.d0*u5+7.d0*u6) 
...
!c
      brak2=2.d0*uln*(24.d0*cb1*(1.d0-3.d0*u4) &
           +cb2*(2.d0-10.d0*u2-3.d0*u4) &
           +6.d0*cb3*u2*(3.d0*u2+2.d0)-8.d0*cb4*u4)
!c
...
!c
                 ...
                 - 135.d0 + 116.d0*u3 - 491.d0*u4 - 22.d0*u5 &
                                                     - 11.d0*u6) &
                 + 2.d0*uln*(6.d0*u6 - 9.d0*u4 + 8.d0*u2 - 2.d0) 
!c
                  v72(ii) = ANS / u3
27235       continue
      end if
...
!c
                 ...
                 - 251.d0*u3 - 85.d0*u4 + 199.d0*u5 - 7.d0*u6  &
                                                     - 7.d0*u6*u) &
                 + 4.d0*uln*(2.d0 + 10.d0*u2 - 9.d0*u4)
!c
                  v73(ii) = ANS / u3
27335       continue
      end if
...
!c
                 ...
                 - 12.d0*u3 + 65.d0*u2 - 50.d0*u - 27.d0) &
                 + 8.d0*uln*(3.d0*u4 - 10.d0*u2 + 2.d0)
!c
                  v74(ii) = ANS / u5
27435       continue
      end if
...
!c
                  ANS1 = uroot*(u - 1.d0)* &
              (  4.d0/3.d0*cb1*u*(u3 + 2.d0*u2 - u + 4.d0) &
                 + cb2/72.d0*(u6 + 2.d0*u5 - 39.d0*u4 - 12.d0*u3 &
                       + 65.d0*u2 - 50.d0*u - 27.d0) &
                 + cb3/12.d0*(u6 + 2.d0*u5 - 31.d0*u4 + 4.d0*u3 &
                       + 57.d0*u2 - 18.d0*u - 27.d0) &
                 + cb4/72.d0*(7.d0*u6 + 14.d0*u5 - 185.d0*u4 &
                       - 100.d0*u3 + 151.d0*u2 + 50.d0*u + 27.d0)  )
!c     
                  ANS2 = uln*(16.d0*cb1*(4.d0*u2 - 1.d0 - u4) &
                 + 2.d0*cb2/3.d0*(2.d0 - 10.d0*u2 + 3.d0*u4) &
                 + 4.d0*cb3*u2*(u2 - 2.d0) &
                 + 2.d0*cb4/3.d0*(9.d0*u4 - 10.d0*u2 - 2.d0) )
!c
                  v75(ii) = (ANS1 + ANS2)/u3
27535       continue
      end if
...
!c
                  ANS1 = uroot*(u - 1.d0)* &
              (  16.d0/3.d0*cb1*u*(2.d0 + u - 2.d0*u2 - u3) &
                 + cb2/36.d0*(73.d0*u4 - 6.d0*u5 - 3.d0*u6 + 44.d0*u3 &
                       - 43.d0*u2 - 50.d0*u - 27.d0) &
                 + cb3/2.d0*(19.d0*u4 - 2.d0*u5 - u6 + 4.d0*u3 &
                       - 9.d0*u2 - 6.d0*u - 9.d0) &
                 + cb4/36.d0*(39.d0*u4 - 2.d0*u5 - u6 + 12.d0*u3 &
                       - 65.d0*u2 + 50.d0*u + 27.d0)                )
!c
                  ANS2 = 4.d0*uln*(8.d0*cb1*(u4 - 1.d0)  &
                 + cb2*(2.d0/3.d0 - u4) - 2.d0*cb3*u4 &
                 + cb4/3.d0*(10.d0*u2 - 2.d0 - 3.d0*u4)  )
!c
                  v76(ii) = (ANS1 + ANS2) / u5
27635       continue
      end if
...
!c                 u-expression of eq (2)                  
                  v78(ii) = (u2 - 4.d0)* &
              (  cb4/3.d0* &
                 (uroot*(2.d0*u2 - 8.d0)*dlog((u + uroot)/2.d0) &
                             + u*(8.d0 + 36.d0*ga2 -5.d0/3.d0*u2)) &
                 + 128.d0*pi2*fpi2*ce17*u*(u2 - 2.d0)              )
27835       continue
      end if
!c
!c     iterate over output points aa(i), store results in them
...
!c                 ANS = eq (3) (times const_factor of [EM D.16])
              ...
              (  2.d0*uroot*(24.d0*cb1 + cb2*(u2 - 4.d0)  &
                       + 6.d0*cb3*u2m2)*dlog((u + uroot)/2) &
                 + u*(cb2*(8.d0 - 5.d0/3.d0*u2) - 6.d0*cb3*u2m2  &
                                                   - 24.0*cb1)  ) &
                 + c52*ce14*(u2m2**3)/u
27935       continue
      end if
...
!c
      brak1=(3.d0*ga2+1.d0)/8.d0*root*(2.d0-u2) &
          +((3.d0*ga2+1.d0)/u-2.d0*ga2*u)*alogfun
      brak2=root/96.d0*(7.d0*u2-6.d0-u4+ga2*(5.d0*u2-6.d0-2.d0*u4)) &
          +(ga2*u2-1.d0-ga2)/(4.d0*u)*alogfun
      brak3=2.d0/9.d0*root*(3.d0*(7.d0*u2-6.d0-u4) &
          +4.d0*ga2*(32.d0/u-12.d0-20.d0*u+7.d0*u2-u4) &
          +ga4*(114.d0-512.d0/u+368.d0*u &
          -169.d0*u2+7.d0*u4+192.d0/(u+2.d0))) &
          +16.d0/(3.d0*u)*(ga4*(6.d0*u4-30.d0*u2+35.d0) &
          +ga2*(6.d0*u2-8.d0)-3.d0)*alogfun
      brak4=2.d0/9.d0*root*(30.d0-128.d0/u+80.d0*u-13.d0*u2-2.d0*u4 &
          +ga2*(512.d0/u-114.d0-368.d0*u &
          +169.d0*u2-7.d0*u4-192.d0/(u+2.d0))) &
          +16.d0/(3.d0*u)*(5.d0-3.d0*u2 &
          +ga2*(30.d0*u2-35.d0-6.d0*u4))*alogfun
!c
      term1=c51*brak1
      term2=c52*brak2
      term3=c53*brak3
...
!c
            aa(i)=aa(i) * c5 * &
        (  wpi5/2.d0/omega2 + (2.d0*c4 + aakk)*(aakk - c4)*cpa(i) )
28105 continue
!c
      mi=mi+1
      mm=mm+1
...
!c
            aa(i)=aa(i) * c5 * &
        (  3.d0*ga2*wpi5/2.d0/omega2 + &
                 (ga2*(3.d0*c4 + 2.d0*aakk) - 2.d0*c4 - aakk)* &
                 (2.d0*c4 + aakk)*cpa(i)      )
28205 continue
!c
      mi=mi+1
